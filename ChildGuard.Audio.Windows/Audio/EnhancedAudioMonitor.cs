...
using AudioEv = ChildGuard.Core.Audio;
...
public class EnhancedAudioMonitor : IDisposable
{
    ...
    // Events
    public event EventHandler<AudioEv.AudioDetectionEventArgs>? OnBadWordDetected;
    public event EventHandler<AudioEv.SpeechDetectedEventArgs>? OnSpeechDetected;
    public event EventHandler<AudioEv.AudioLevelEventArgs>? OnAudioLevelChanged;
    ...
    private void OnAudioDataAvailable(object? sender, WaveInEventArgs e)
    {
        ...
        OnAudioLevelChanged?.Invoke(this, new AudioEv.AudioLevelEventArgs
        {
            Level = maxValue,
    ...
    private void OnSpeechRecognized(object? sender, SpeechRecognizedEventArgs e)
    {
        ...
        OnSpeechDetected?.Invoke(this, new AudioEv.SpeechDetectedEventArgs
        {
            Text = text,
        ...
        if (!result.IsClean)
        {
            OnBadWordDetected?.Invoke(this, new AudioEv.AudioDetectionEventArgs
            {
                Timestamp = DateTime.Now,
